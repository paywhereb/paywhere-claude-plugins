...
./scripts/package.sh paywhere-smb        # → dist/paywhere-smb-1.0.4.plugin
```
...
2. Open the demo Cowork project (instructions = `cowork-project-prompt.md`;
   plugin 1.0.4 side-loaded; four connectors signed in as demo-nick).
...
| Skill "executed" or says "paid ✓" | Stale skill text | You are on an old plugin version; rebuild + side-load 1.0.4 |
