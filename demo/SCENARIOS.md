...
3. Side-load `dist/paywhere-smb-1.0.3.plugin` (presenter-kit §2).
...
- [ ] Cowork project created; `cowork-project-prompt.md` pasted as its instructions; plugin 1.0.3 side-loaded.
