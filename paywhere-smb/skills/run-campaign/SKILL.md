...
1. Pull sales data from QuickBooks for the lookback window.
...
- If any connector is unreachable (QuickBooks, Canva, HubSpot), stop, report which connector failed, and ask whether to retry or abort.
