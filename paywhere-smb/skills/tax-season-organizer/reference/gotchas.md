...
## Paywhere-only contractor payments

**BAD:** Skip a contractor entirely because they don't appear in QuickBooks vendor records.

**GOOD:** Cross-check Paywhere ACH/wire history against QB vendors. When a
recurring payment to the same counterparty shows up in Paywhere but never
appears in QB, flag it.
> "Smith Consulting received $4,200 in ACH payments from your operating
> account over the year but has no QB vendor record. Confirm with your
> accountant — this may be a missed 1099-NEC obligation."
