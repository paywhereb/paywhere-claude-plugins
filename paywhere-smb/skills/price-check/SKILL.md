...
If QuickBooks is unreachable, stop — margin analysis requires QB revenue and cost data. If Paywhere is missing, run from QB-only and note "Paywhere not connected — cash cross-check against bank inflow skipped."
...
- **Never update any prices in QB or any connected system.**
