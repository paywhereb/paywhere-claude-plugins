...
**Connectors:** QuickBooks (revenue + costs by product/service)
...
- **QuickBooks:** 14 months of invoice line items + COGS by product category
...
- This example assumes online and in-store sales both flow through QuickBooks as a single product-level register. Where the owner uses a separate POS, surface that as a data-quality note.
