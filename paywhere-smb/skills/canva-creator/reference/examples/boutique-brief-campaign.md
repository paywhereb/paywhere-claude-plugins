...
|------|---------|-------|------------|---------------|
| Jun 2 | Instagram feed | Linen dresses launch | 1:1 post | Product intro — "finally, a dress you can wear to both places" |
...
| Jun 9 | Instagram feed | Linen styling tip | 1:1 post | Education — "3 ways to style the linen midi" |
...
```
Claude: I found 3 1:1 feed-post templates in your Canva library:
  1. Boutique Feed - Cream    (last edited Apr 2026)
...
Claude: Got it. I'll use "Boutique Feed - Cream" for all feed posts.
