...
> "I had to escalate twice before anyone got back to me about my refund." — [Intercom]
...
## Example: HubSpot unavailable run

**Trigger used:** "Customer pulse for last 30 days"

### Sources pulled
- HubSpot tickets: unavailable — not included
- Gmail threads: 11
- Intercom conversations: 4
- Pasted reviews: 3

*(Report continues normally with available sources. The HubSpot note appears only in Sources — no error message in the body.)*
